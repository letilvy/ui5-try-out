			...
			actions : Object.assign({
				...
				iSearchForValueWithActions : function (aActions) {
					return this.waitFor({
						...
						viewName : sViewName,
						actions: aActions,
						errorMessage : "Failed to find search field in Recommend view.'"
					});
				},
						...
						success : function (oTable) {
							...
							this.waitFor({
								...
								matchers : function (oPage) {
									var sExpectedText = oPage.getModel("i18n").getResourceBundle().getText("recommendTableTitleCount", [iObjectCount]);
					...
					return this.waitFor({
						...
						success : function (oTable) {
							Opa5.assert.strictEqual(
								...
								oTable.getModel("i18n").getProperty("recommendNoDataWithSearchText"),
