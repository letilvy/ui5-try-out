sap.ui.define([
	...
	return Opa5.extend("sap.ui5.tryout.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["sap/ui5/tryout/localService/mockserver"], function (mockserver) {
